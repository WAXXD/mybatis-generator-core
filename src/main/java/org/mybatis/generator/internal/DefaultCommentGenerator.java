...
//        }
        ...
        topLevelClass
                .addJavaDocLine(" * Date: " + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy" +
                        "-MM-dd HH:mm:ss")) + "."); //$NON-NLS-1$


        StringBuilder sb = new StringBuilder();
        sb.append(introspectedTable.getFullyQualifiedTable());
        topLevelClass.addJavaDocLine(" * Table: " + sb.toString() + ".");
...
//        }
        ...
        field.addJavaDocLine(" *   Desc: " + remarks);
